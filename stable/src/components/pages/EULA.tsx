      ...
      <ScrollArea className="h-[70vh] w-full rounded-md border p-4">
        <div className="pr-4">
          <p className="mb-4">
            ...
            BobbySimms ("Software"), which includes related documentation and
            may include associated media, printed materials, and online or
            electronic documentation (collectively, the "Software").
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            Evolutions may terminate this Agreement at any time if you violate
            any of the terms. Upon termination, you must cease all use of the
            Software and destroy all copies of it.
          </p>
          <h2 className="text-xl font-semibold mt-6 mb-2">
          ...
          <p className="mb-4">
            To the fullest extent permitted by law, in no event will JT
            Evolutions be liable for any indirect, incidental, special, or
            consequential damages, or damages for loss of profits, revenue,
            data, or use, incurred by you or any third party, whether in an
            action in contract or tort, arising from your use of the Software.
          </p>
          <h2 className="text-xl font-semibold mt-6 mb-2">
            8. Indemnification
          </h2>
          ...
          <p className="mb-4">
            ...
            Evolutions and supersedes all prior agreements, written or oral,
